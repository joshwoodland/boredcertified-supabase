      ...
      <div className="fixed inset-0 z-[151] flex items-center justify-center p-4" onClick={handleBackdropClick}>
        ...
        >
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-center text-gray-500 dark:text-dark-muted">
          ...
          <div className="flex border-t dark:border-dark-border">
            ...
            <button
              ...
              className="flex-1 px-6 py-4 text-red-600 dark:text-red-400 hover:bg-gray-50 dark:hover:bg-dark-accent transition-colors font-medium"
            >
              Delete
            </button>
          </div>
