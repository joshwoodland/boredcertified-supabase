...
var systemMessages = require('./app/config/systemMessages').systemMessages;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, prisma.sOAPNote.deleteMany({})];
                case 1:
                    // First clear any existing data to avoid conflicts
                    _a.sent();
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.appSettings.deleteMany({})];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.appSettings.upsert({
                            where: { id: 'default' },
                            update: {
                                darkMode: true,
                                autoSave: true,
                                gptModel: 'gpt-4-turbo-preview',
                                initialVisitPrompt: systemMessages.initialVisit,
                                followUpVisitPrompt: systemMessages.followUpVisit,
                                updatedAt: new Date()
                            },
                            create: {
                                id: 'default',
